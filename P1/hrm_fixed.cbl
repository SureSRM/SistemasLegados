       ...
       MAIN-PARA.
           ...
           DISPLAY "3 LIST BRANCH FILE" AT LINE 14 COL 25.
           DISPLAY "4 EXIT" AT LINE 16 COL 25.
           DISPLAY "ENTER YOUR CHOICE :" AT LINE 18 COL 25.
           ACCEPT CHOICE AT LINE 18 COL 46.
           IF CHOICE = 1
              CALL "EMPWRITE"
              CANCEL "EMPWRITE"
              GO TO MAIN-PARA
       ...
       GR-READ-PARA.
           ...
           IF GGRADE = GR
           DISPLAY " GRADE NO AT LINE 1 COL 1.   :" GGRADE.
       ...
       REVISION-PARA.
           ...
           DISPLAY "ENTER TECH AT LINE 9 COL 1. JOURNAL :".
       ...
       MAIN.
           ...
           SET HASNEXT TO 1.
           OPEN INPUT BRANCHFILE.
           PERFORM PRINT-PAGE WITH TEST BEFORE UNTIL HASNEXT=0.
           CLOSE BRANCHFILE.
           EXIT PROGRAM.
